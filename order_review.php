...
$deliveryFee = ($_POST['payment_mode'] === 'Cash') ? 0 : 130;
    ...
    <div class="order-summary">
        ...
        <?php foreach ($itemDetails as $item) : ?>
          <div class="order-item d-flex align-items-center">
            ...
            <div class="ms-1 row d-flex justify-content-between w-100">
              ...
              <div class="col d-flex flex-column justify-content-center">
                <div class="d-flex flex-row justify-content-end align-items-center mt-2"> Ksh <?= htmlspecialchars($item['price'], 0) ?> x <?= htmlspecialchars($item['quantity']) ?></div>
                <div class="d-flex flex-row justify-content-end align-items-start mb-2">
                  <span class="badge rounded-pill text-light p-2 mt-2 item-total-price" style="background-color: #fb4a36;">Ksh <?= $item['total_price'] ?></span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="summary-details">
        <div class="fee-details">
          ...
          <div>Ksh <?= number_format($subtotal) ?></div>
        </div>
        <div class="fee-details">
        ...
        <div class="fee-details">
          ...
          <div>Ksh <?= number_format($deliveryFee) ?></div>
        </div>
        <div class="fee-details">
          <div><strong>Total:</strong></div>
          <div>Ksh <?= number_format($total) ?></div>
        </div>
      </div>
      <hr>
      <?php
