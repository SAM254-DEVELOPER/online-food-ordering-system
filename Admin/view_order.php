...
$paymentMode = $order['pmode'] ?? 'Cash'; // Default to 'takeaway' if not set

// Determine the delivery fee based on the payment mode
$deliveryFee = ($paymentMode === 'Cash') ? 0 : 130;
?>
<?php
include 'sidebar.php';
?>
      ...
      <div class="order-details">
              ...
              <li class=" d-flex justify-content-between  mb-3">
                ...
                <div>
                  <div class="d-flex flex-row justify-content-between align-items-start quantity-price">
                    <div>
                      Ksh <?php echo $item['price']; ?> x <?php echo $item['quantity']; ?>
                    </div>
                  </div>
                  <div class="d-flex flex-row justify-content-end align-items-end">
                    <span class="badge rounded-pill text-light p-2 mt-2" style="background-color: #fb4a36; ">Ksh <?php echo $item['total_price']; ?></span>
                  </div>
                </div>
              </li>
            <?php endwhile; ?>
        ...
        <div class="order-summary">
          ...
          <div class="summary-details">
            ...
            <p> Ksh <?php echo $order['sub_total']; ?></p>
          </div>

          <div class="summary-details">
            <p><strong>Fee:</strong></p>
            <p>Ksh <?= number_format($deliveryFee, 2) ?></p>
          </div>
          <div class="summary-details">
            <p><strong>Total:</strong></p>
            <p> Ksh <?php echo $order['grand_total']; ?></p>
          </div>
          <div class="summary-details">
