      ...
      <div class="container mt-3">
        <div class="row d-flex justify-content-start align-items-start main-container">
          <div class="col-md-5 col-sm-12 col-lg-5 reveal main-text mb-4 text-align-justify mt-5" data-aos="fade-up">
            <h2>Welcome to <span style="color: #fb4a36;"> SAM'S CAFE,</span></h2>
            ...
            <p style="font-size: 18px; text-align: justify;">
              ...
              flavor. At SAM'S CAFE, we believe in making every meal an
          ...
          <div class="col-md-7 col-sm-12 col-lg-7 d-flex justify-content-center align-items-start slide-in-right main-image">
            <img src="images/cafe-6677492_960_720.jpg" class="img" style=" width: 85%; height: 80%;">
          </div>
        </div>
        <div class="row">
          <!-- Menu Section -->
    ...
    <div class="container">
      <div class="row why-us-content">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 d-flex flex-column justify-content-center reveal" data-aos="fade-up">
          ...
          <p class="content">Our cafe offers the best food delivery service with fresh and high-quality ingredients.</p>
          ...
          <div class="carousel-inner">
            ...
            foreach ($chunkedItems as $items) {
              ...
              foreach ($items as $item) {
                ...
                echo '<p class="card-text text-center">Ksh ' . $item['price'] . '</p>';
      ...
      <div class="container ">
        ...
        <div class="story-content row mb-2">
          <div class="story-text col-lg-6 col-md-6 col-sm-12 reveal mt-2" data-aos="fade-up" data-os-interval="300">
            <p>At <strong>SAM'S CAFE</strong>, we are passionate about celebrating food. Our chefs bring a touch of creativity to every dish, ensuring a feast for your senses. Join us for an extraordinary dining experience that celebrates flavor and joy.</p>
            <p>Founded in [2024], SAM'S CAFE has been at the forefront of culinary innovation. Our commitment to using the freshest ingredients, combined with our chefs' expertise, has earned us a reputation for excellence. We believe that dining is not just about eating; it's about experiencing the art of food.</p>
            <p>Whether you're looking for a romantic dinner, a family gathering, or a place to celebrate special occasions, SAM'S CAFE offers the perfect ambiance and exquisite cuisine to make your visit unforgettable. Come and experience the joy of flavor with us!</p>
      ...
      <div class="row">
        <div class="clients-carousel owl-carousel" data-aos="fade-up">
          ...
          <div class="single-box">
            ...
            <div class="content">
              <p>"The online food ordering process was seamless and easy to navigate. My food arrived hot and on time. The delivery service was very professional."</p>
              <h4>-Zidnan</h4>
            </div>
          </div>
          <div class="single-box">
          ...
          <div class="single-box">
            ...
            <div class="content">
              ...
              <p>"The online food ordering system is fantastic. It’s easy to customize my order, and the delivery is always prompt. The food arrives hot and tasty every time."</p>
              <h4>-jimmy</h4>
            </div>
          </div>
        </div>
    ...
    <div class="footer-container">
      <div class="footer-row">
        <div class="footer-col" id="contact">
          <h4>Contact Us</h4>
          <p>123 ABC Road, KITALE</p>
          <p>Email: info@sam'scafe.com</p>
          <p>Phone: +254 74 899 0063</p>
        </div>
      ...
      <div class="footer-bottom">
        <h4>&copy; 2025 Developed by Samuel Wabwire. All Rights Reserved.</h4>
      </div>
    </div>
  </footer>
