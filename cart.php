  ...
  <div class="cart-details ">
            ...
            <li class="d-flex justify-content-between align-items-center mb-3 list-group-item">
              ...
              <div class="mt-1">
                <div class="d-flex flex-row justify-content-between align-items-start quantity-price">
                  <div>
                    Ksh <span class="item-price"><?= $item['price'] ?></span> x <span class="item-quantity"><?= $item['quantity'] ?></span>
                  </div>
                </div>
    ...
    <div class="order-summary">
      ...
      <div class="summary-details payment">
        ...
        <div>
          <input type="radio" id="M-pesa" name="payment_mode" value="M-pesa">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function updateDeliveryFee() {
        ...
        deliveryFee = selectedPaymentMode === 'Cash' ? 0 : 130;
        updateSummary();
      }
      ...
      function updateQuantity(element, change, isInput = false) {
        ...
        itemContainer.querySelector('.item-total-price').textContent = 'Ksh ' + itemTotalPrice;
